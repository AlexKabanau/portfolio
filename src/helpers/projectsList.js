...
export const projects = [
  {
    ...
    responsibilities: [
      'BACKEND',
      'Use Nest like a main framework for building the backend application (API).',
      'Prisma - for interacting with the database.',
      'Use JWT (JSON Web Tokens) for authentication and authorization.',
      'Argon2 for password hashing.',
      'Class-transformer and class-validator for data (dto) validation and transformation',
      'Cookie-parser for parsing cookies in incoming HTTP requests.',
      'Use date-fns lib. for working with dates',
      'Passport - authentication middleware for Node.js, integrated into the application for handling various authentication strategies.',
      'passport-jwt - a Passport strategy for authenticating requests using JSON Web Tokens (JWT).',
      '',
      'FRONTEND',
      'Use Next like a main framework for building the frontend application (SSR and SSG).',
      'Tanstack (Tanstack Query) for management server-state in React. ',
      'Dnd-kit and hello-pangea/dnd (a fork of react-beautiful-dnd) realization of drag-and-drop functionality, used for creating sortable lists or kanban boards.',
      'Use Axios for HTTP API requests.',
      'Clsx for conditionally joining class names for dynamically apply styles based on component state or props.',
      'Dayjs for working with dates and times. DayOfWeek and WeekOfYear for dashboards.',
      'Js-cookie for handling cookies in the browser. Creating, reading, and managing cookies.',
      'Lodash.debounce for delays the execution of a function',
      'Lucide-react for icons',
      'React-day-picker for creating interactive date pickers.',
